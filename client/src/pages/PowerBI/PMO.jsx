...
import { 
  ...
  DialogActions, TextField, CircularProgress, Tooltip 
} from '@mui/material';
import { Edit as EditIcon } from '@mui/icons-material';
import PowerBIEmbed from '../../components/UI/PowerBIEmbed'; // Seu componente reutilizável
...
export default function PMO() {
  ...
  // A chave que definimos no banco de dados para este relatório
  const LINK_KEY = 'pbi_pmo'; 

  // URL Padrão (Fallback caso o banco falhe ou demore) - A que você enviou
  const defaultUrl = "https://app.powerbi.com/view?r=eyJrIjoiNzE4NDdjY2ItZTVhYy00NThiLTg0ZmQtNmY5YmFjOTE1YTQzIiwidCI6ImMzN2RhMWY3LWE3MzctNDJjNS1hMDQ1LTIzMGE2NjM2ZjQ0NiJ9";
  ...
  return (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)} fullWidth maxWidth="md">
        <DialogTitle>Editar Link do Power BI - PMO</DialogTitle>
        <DialogContent>
